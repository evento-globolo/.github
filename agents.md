...
When integrating upstream or concurrent work, avoid git rebase in favor of git merge so shared history remains reviewable.
...
3. Review linked pull requests, issues, Linear work, related repositories in `evento-globolo`, and relevant external-organization repositories whenever behavior or contracts cross boundaries.
