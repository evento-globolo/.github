...
repository="evento-globolo/evgl-e2e"
...
git -C "$work_dir" commit -m "bootstrap canonical evgl-e2e harness"
gh repo create "$repository" --public \
  --description "Canonical Evento Globolo end-to-end and contract test harness" \
