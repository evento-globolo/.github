...
This public repository is the canonical source for GitHub-supported fallback community files, organization profile content, reusable workflow examples, and public contributor guidance for [`evento-globolo`](https://github.com/evento-globolo).

- GitHub owner: [`evento-globolo`](https://github.com/evento-globolo)
